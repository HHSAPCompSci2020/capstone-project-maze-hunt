...
//	import javax.swing.JOptionPane;
	...
	public class WrongAnswer4 extends Screen {
		
		private DrawingSurface surface;
		private Rectangle startButton;

		
		public WrongAnswer4(DrawingSurface surface) {
			super(400,300);
		...
		public void mousePressed() {
			...
			if (startButton.contains(p))
				surface.switchScreen(ScreenSwitcher.KEYBOARDPRESS); //switch to welcome screen
